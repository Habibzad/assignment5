...
//	private static CDOffering[] cdOfferings = new CDOffering[0];
	...
	public class MeritBank {
		...
		public static AccountHolder addAccountHolder(AccountHolder id) {
			accHolderList.add(id);
			return id;
		}
		public static AccountHolder[] getAccountHolders() {
				...
				for(int i=0;i<accHolderList.size();i++) {
					...
					if(numOfCheckings!=0) {
						...
						for(int j=0;j<numOfCheckings;j++) {
							wr.println(checking[j].toString());
						}
					}
